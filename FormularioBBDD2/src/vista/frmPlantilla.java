	...
	private void eventos() {
		...
		btnBorrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Libro libro = new Libro(textIsbn.getText(), textTitulo.getText(), textAutor.getText(), textEditorial.getText(), textFechaPrestamo.getText(), tick);
					libroController.borrarDatos(libro);
