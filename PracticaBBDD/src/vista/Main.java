...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*Libro libro = new Libro(0, "ujiño", "ujo", "ugondo", true, LocalDate.now(), LocalDate.now(), "15987", LocalDateTime.now());
			if (biblioteca.editarLibro(libro)) {
				System.out.println("Se ha editado el libro correctamente");
			} else {
				System.out.println("Fallo al editar libro");
			}
			Libro libro = new Libro(0, "ujiño", "ujo", "ugondo", true, LocalDate.now(), LocalDate.now(), "15987", LocalDateTime.now());
			if (biblioteca.borrarLibro(libro)) {
